...
<span class="likeLinkContainer" id="likeLinkContainer_<?= $id ?>">
    ...
    <?php else: ?>
        <?php echo Html::a(Yii::t('LikeModule.widgets_views_likeLink', 'plus_one'), $likeUrl, ['style' => 'display:' . ((!$currentUserLiked) ? 'inline' : 'none'), 'class' => 'like material-icons likeAnchor', 'data-objectId' => $id]); ?>
